...
var url = 'https://olympiad-server.onrender.com/news_items/';
...
function appendHomeNews(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        div_tag.setAttribute("data-id", data[i].id);
        ...
        a_tag.setAttribute("title", data[i].a_title);
        ...
        a3_tag.setAttribute("href", data[i].link);
